        ...
        <div className="flex ml-5 space-x-1 space-y-1 w-5/6 place-self-stretch justify-center pt-6">
          <div className="flex flex-col">
            ...
            <h3 className="text-left p-5">
              ...
              software development. For example, arrays are used to store data in a list format:<br /><br />Python code (prints to the console:
              &quot;1 2 3 4 5 &quot;):<br /><br />
              <p className="w-1/4 border-b border-gray-300 bg-gradient-to-b from-zinc-200 pb-6 pt-8 backdrop-blur-2xl dark:border-neutral-800 dark:bg-zinc-800/30 dark:from-inherit lg:static
              ...
              Structuring data in different ways allows us as programmers to solve problems more efficiently. For example, if one wanted to store data
              in a structure that will not have a fixed size, one would preferably use a linked list over an array, since arrays are created in
